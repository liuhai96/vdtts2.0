!function (t, e) {
    ...
    function f(t, e, n) {
        if (t && e) if (t.forEach && t.forEach === ip) t.forEach(e, n); else if (t.length === +t.length) for (var i = 0, r = t.length; r > i; i++) e.call(n, t[i], i, t); else for (var a in t) t.hasOwnProperty(a) && e.call(n, t[a], a, t)
    }
    ...
    function ge(t, e, n, i, r) {
        if (e.getBoundingClientRect && Qf.domSupported && !ye(e)) {
            var a = e[bp] || (e[bp] = {}), o = ve(e, a), s = me(o, a, r);
    ...
    function gn(t, e, n) {
        ...
        if (i !== r) {
            var a = i > r;
            if (a) t.length = r; else for (var o = i; r > o; o++) t.push(1 === n ? e[o] : tg.call(e[o]))
        }
    ...
    function Fn(t, e, n) {
        var i = up(), r = e.getWidth(), a = e.getHeight(), o = i.style;
    ...
    function ci(t, e, n, i, r, a) {
        var o, s = vi(i), l = !1, u = e.__attrCachedBy === yg.PLAIN_TEXT;
        ...
        var g = p.outerHeight, v = p.lines, m = p.lineHeight, y = _i(Vg, t, i, r), _ = y.baseX, x = y.baseY,
    ...
    function fi(t, e, n, i, r) {
        var a = n.width, o = n.outerWidth, s = n.outerHeight, l = i.textPadding, u = _i(Vg, t, i, r), h = u.baseX,
    ...
    function rr(t) {
        ...
        cv(t, function (t) {
            ...
            if (dv(r)) {
                if (a.name = null != r.name ? r.name + "" : i ? i.name : pv + n, i) a.id = i.id; else if (null != r.id) a.id = r.id + ""; else {
                    var o = 0;
        ...
        if (wr(h) && wr(c)) if (wr(s)) a[0] = 0; else {
            ...
            if (wr(g)) {
                ...
                var w = (2 * h * s - 3 * o * c) / (2 * Tv(h * h * h)), b = Math.acos(w) / 3, S = Tv(h), M = Math.cos(b),
                    p = (-s - 2 * S * M) / (3 * o), m = (-s + S * (M + Av * Math.sin(b))) / (3 * o),
    ...
    function Rr(t, e, n, i, r, a, o, s, l, u) {
        var h, c = Tr, d = Sr, f = c(t, n, r, o, Gv);
    ...
    function Nr(t, e, n, i, r, a, o, s) {
        var l = Lr, u = Ar, h = Ev(Bv(l(t, n, r), 1), 0), c = Ev(Bv(l(e, i, a), 1), 0), d = u(t, n, r, h),
            f = u(e, i, a, c);
    ...
    function jr(t, e, n, i, r, a, o, s, l, u) {
        ...
        for (var c, d, f = 0, p = -1, g = 0; h > g; g++) {
            var v = lm[g], m = 0 === v || 1 === v ? .5 : 1, y = Sr(t, n, r, o, v);
    ...
    function Zr(t, e, n, i, r, a, o, s) {
        ...
        if (u >= 0 && 1 >= u) {
            for (var h = 0, c = Ar(e, i, a, u), d = 0; l > d; d++) {
                var f = 0 === lm[d] || 1 === lm[d] ? .5 : 1, p = Ar(t, n, r, lm[d]);
                o > p || (h += lm[d] < u ? e > c ? f : -f : c > a ? f : -f)
            }
            return h
        }
        var f = 0 === lm[0] || 1 === lm[0] ? .5 : 1, p = Ar(t, n, r, lm[0]);
    ...
    function ea(t, e, n, i, r, a, o, s, l, u, h) {
        var c = l * (wm / 180), d = xm(c) * (t - n) / 2 + _m(c) * (e - i) / 2,
            f = -1 * _m(c) * (t - n) / 2 + xm(c) * (e - i) / 2, p = d * d / (o * o) + f * f / (s * s);
        p > 1 && (o *= ym(p), s *= ym(p));
        var g = (r === a ? -1 : 1) * ym((o * o * s * s - o * o * f * f - s * s * d * d) / (o * o * f * f + s * s * d * d)) || 0,
            v = g * o * f / s, m = g * -s * d / o, y = (t + n) / 2 + xm(c) * v - _m(c) * m,
            _ = (e + i) / 2 + _m(c) * v + xm(c) * m, x = Mm([1, 0], [(d - v) / o, (f - m) / s]),
            w = [(d - v) / o, (f - m) / s], b = [(-1 * d - v) / o, (-1 * f - m) / s], S = Mm(w, b);
    ...
    function oo(t, e) {
        var n = Km(t.x, e.x), i = $m(t.x + t.width, e.x + e.width), r = Km(t.y, e.y),
    ...
    function os(t) {
        var e = t.option, n = e.data, i = I(n) ? Uy : Vy, r = !1, a = e.seriesLayoutBy, o = e.sourceHeader,
    ...
    function ss(t, e, n, i, r) {
        ...
        if (e === Hy) "auto" === i || null == i ? us(function (t) {
            ...
            r[e] = null != t ? t : ""
        }, n, t)), a = r ? r.length : n === qy ? t.length : t[0] ? t[0].length : null; else if (e === Gy) r || (r = hs(t)); else if (e === Wy) r || (r = [], f(t, function (t, e) {
            r.push(e)
        })); else if (e === Vy) {
            var s = er(t[0]);
            a = x(s) && s.length || 1
    ...
    function us(t, e, n, i) {
        if (null == i && (i = 1 / 0), e === qy) for (var r = 0; r < n.length && i > r; r++) t(n[r] ? n[r][0] : null, r); else for (var a = n[0] || [], r = 0; r < a.length && i > r; r++) t(a[r], r)
    }
    ...
    function cs(t, e, n) {
        ...
        var a = {}, o = fs(e);
        if (!o || !t) return a;
        var s, l, u = [], h = [], c = e.ecModel, d = Zy(c).datasetMap, p = o.uid + "_" + n.seriesLayoutBy;
    ...
    function ys(t) {
        t = t, this.option = {}, this.option[Ky] = 1, this._componentsMap = N({series: []}), this._seriesIndices, this._seriesIndicesMap, ms(t, this._theme.option), r(t, Ry, !1), this.mergeOption(t)
    }
    ...
    function Ps(t) {
        var e = t && t.itemStyle;
        if (e) for (var n = 0, i = s_.length; i > n; n++) {
            var a = s_[n], o = e.normal, s = e.emphasis;
    ...
    function Bs(t, e) {
        var n = o_(t) && t[e], i = o_(n) && n.textStyle;
        if (i) for (var r = 0, a = gv.length; a > r; r++) {
            var e = gv[r];
    ...
    function zs(t) {
        if (o_(t)) {
            ...
            var e = t.markPoint;
            if (e && e.data) for (var s = e.data, o = 0; o < s.length; o++) Es(s[o]);
            var n = t.markLine;
            if (n && n.data) for (var l = n.data, o = 0; o < l.length; o++) x(l[o]) ? (Es(l[o][0]), Es(l[o][1])) : Es(l[o]);
    ...
    function _l(t, e, n, i, r) {
        function a(n) {
            var a = n.uid, s = o.get(a) || o.set(a, Qs({plan: Il, reset: Tl, count: Dl}));
            s.context = {
                model: n,
                ecModel: i,
                api: r,
    ...
    function Jl(t, e, n, i) {
        function r(t) {
            ...
            if (!r) {
                var h = cx(t.type), c = a ? S_.getClass(h.main, h.sub) : hl.getClass(h.sub);
    ...
    function wu(t, e, n) {
        ...
        var i = hx(t) ? t.type : [t, t = {event: e}][0];
    ...
    function Yu(t, e, n, i, r) {
        var a = tw[e.type], o = i - 1, s = e.name, l = t[s][o];
        if (l && l.length < n) {
    ...
    function Ju(t, e) {
        var n = t.dimensions, i = new ow(p(n, t.getDimensionInfo, t), t.hostModel);
        Uu(i, t);
    ...
    function nh(t, e, n) {
        ...
        for (var M = _ || "value", I = 0; c > I; I++) {
            var v = h[I] = h[I] || new Gu, T = v.coordDim;
    ...
    function oh(t) {
        var e = t.get("coordinateSystem"), n = new ah(e), i = hw[e];
    ...
    function cc(t) {
        ...
        for (var l = a[0], u = t.dataToCoord(l + 1) - t.dataToCoord(l), h = Math.abs(u * Math.cos(i)), c = Math.abs(u * Math.sin(i)), d = 0, f = 0; l <= a[1]; l += s) {
            var p = 0, g = 0, v = Un(n(l), e.font, "center", "top");
            p = 1.3 * v.width, g = 1.3 * v.height, d = Math.max(d, p, 7), f = Math.max(f, g, 7)
        }
        var m = d / h, y = f / c;
        isNaN(m) && (m = 1 / 0), isNaN(y) && (y = 1 / 0);
        var _ = Math.max(0, Math.floor(Math.min(m, y))), x = Jw(t.model), w = t.getExtent(), b = x.lastAutoInterval,
            S = x.lastTickCount;
    ...
    function kc(t, e, n) {
        ...
        var h = new Fm({shape: {x: a, y: o, width: s, height: l}});
        return e && (h.shape[r ? "width" : "height"] = 0, to(h, {shape: {width: s, height: l}}, n)), h
    }

    function Pc(t, e, n) {
        var i = t.getArea(), r = new Pm({
            shape: {
                cx: bo(t.cx, 1),
                cy: bo(t.cy, 1),
                r0: bo(i.r0, 1),
    ...
    function Nc(t, e) {
        var n = t.get(_b) || 0, i = isNaN(e.width) ? Number.MAX_VALUE : Math.abs(e.width),
    ...
    function Jc(t, e, n) {
        ...
        if (r && !i.scale.isBlank()) {
            var a = e.getModel("axisLabel"), o = a.get("margin"), s = i.getViewLabels(),
                l = (D(n.labelRotate, a.get("rotate")) || 0) * Db / 180, u = Lb(n.rotation, l, n.labelDirection),
                h = e.getCategories && e.getCategories(!0), c = [], d = Ob(e), p = e.get("triggerEvent");
            return f(s, function (r, s) {
                ...
                var m = v.getTextColor() || e.get("axisLine.lineStyle.color"), y = i.dataToCoord(l),
                    ...
                    x = new Cm({anid: "label_" + l, position: _, rotation: u.rotation, silent: d, z2: 10});
                Wa(x.style, v, {
                    text: f,
    ...
    function Pd(t, e, n, i, r, a, o, s, l, u, h) {
        for (var c = 0, d = n, f = 0; i > f; f++) {
            ...
            if (d === n) t[a > 0 ? "moveTo" : "lineTo"](p[0], p[1]), Qb(tS, p); else if (l > 0) {
                var g = d + a, v = e[g];
                if (h) for (; v && Dd(e[g]);) g += a, v = e[g];
                var m = .5, y = e[c], v = e[g];
                if (!v || Dd(v)) Qb(eS, p); else {
                    Dd(v) && !h && (v = p), q(Jb, v, y);
                    var _, x;
                    if ("x" === u || "y" === u) {
                        var w = "x" === u ? 0 : 1;
    ...
    function Ud(t, e) {
        dg.call(this);
        var n = new Pm({z2: 2}), i = new zm, r = new Cm;
    ...
    function $d(t, e) {
        var n = by(e.get("padding")), i = e.getItemStyle(["color", "opacity"]);
    ...
    function hf(t, e, n) {
        var i = n.getZr(), r = "axisPointerLastHighlights", a = RS(i)[r] || {}, o = RS(i)[r] = {};
        ES(t, function (t) {
    ...
    function xf(t, e) {
        if (!Qf.node) {
            var n = e.getZr(), i = (FS(n).records || {})[t];
    ...
    function Df(t, e, n, i, r) {
        var a = n.get("value"), o = kf(a, e.axis, e.ecModel, n.get("seriesDataIndices"), {
            ...
            }), s = n.getModel("label"), l = by(s.get("padding") || 0), u = s.getFont(), h = Un(o, u), c = r.position,
    ...
    function Ff(t) {
        ...
        return n && e.push(Rf(n)), i && (Qf.canvasSupported ? e.push("background-Color:" + i) : (e.push("background-Color:#" + rn(i)), e.push("filter:alpha(opacity=70)"))), qS(["width", "color", "radius"], function (n) {
            var i = "border-" + n, r = jS(i), a = t.get(r);
    ...
    var Qf = $f, Jf = {
        ...
        }, ep = Object.prototype.toString, np = Array.prototype, ip = np.forEach, rp = np.filter, ap = np.slice,
        op = np.map, sp = np.reduce, lp = {}, up = function () {
    ...
    var dp = (Object.freeze || Object)({
            ...
            concatArray: F,
            noop: V
        }), fp = "undefined" == typeof Float32Array ? Array : Float32Array, pp = j, gp = Z, vp = ee, mp = ne,
    ...
    var _p = Array.prototype.slice, xp = function (t) {
        this._$handlers = {}, this._$eventProcessor = t
    };
    xp.prototype = {
        constructor: xp, one: function (t, e, n, i) {
    ...
    var wp = Math.log(2), bp = "___zrEVENTSAVED", Sp = [],
        Mp = "undefined" != typeof window && !!window.addEventListener,
        Ip = /^(?:mouse|pointer|contextmenu|drag|drop)|click/, Tp = [], Cp = Mp ? function (t) {
    ...
    Lp.prototype = {
        constructor: Lp, setHandlerProxy: function (t) {
    ...
    var Op = "undefined" == typeof Float32Array ? Array : Float32Array, Bp = (Object.freeze || Object)({
        create: Le,
        identity: Oe,
        copy: Be,
        mul: Ee,
    ...
    Np.updateTransform = function () {
        ...
        if (null != r && 1 !== r) {
            ...
            var a = Fp[0] < 0 ? -1 : 1, o = Fp[1] < 0 ? -1 : 1, s = ((Fp[0] - a) * r + a) / Fp[0] || 0,
                l = ((Fp[1] - o) * r + o) / Fp[1] || 0;
    ...
    Ge.prototype = {
        constructor: Ge, step: function (t, e) {
            ...
            if (!(0 > n)) {
                n = Math.min(n, 1);
                var i = this.easing, r = "string" == typeof i ? Gp[i] : i, a = "function" == typeof r ? r(n) : n;
    ...
    var jp = {
    ...
    }, Zp = new Yp(20), Kp = null, $p = an, Qp = on, Jp = (Object.freeze || Object)({
        parse: Je,
        lift: nn,
        toHex: rn,
        fastLerp: an,
        ...
        modifyAlpha: ln,
        stringify: un
    }), tg = Array.prototype.slice, eg = function (t, e, n, i) {
    ...
    var ig = 0, rg = ng, ag = function () {
    };
    1 === ig && (ag = console.error);
    var og = ag, sg = function () {
        this.animators = []
    };
    sg.prototype = {
    ...
    var ug = ae, hg = Math.min, cg = Math.max;
    Tn.prototype = {
        constructor: Tn, union: function (t) {
            var e = hg(t.x, this.x), n = hg(t.y, this.y);
    ...
    var fg = 32, pg = 7, gg = function () {
        this._roots = [], this._displayList = [], this._displayListLen = 0
    };
    gg.prototype = {
        constructor: gg, traverse: function (t, e) {
    ...
    var vg = {
        ...
        }, yg = {NONE: 0, STYLE_BIND: 1, PLAIN_TEXT: 2}, _g = 9,
    ...
    wg.prototype = {
        ...
        blend: null,
        bind: function (t, e, n) {
            var i = this, r = n && n.style, a = !r || t.__attrCachedBy !== yg.STYLE_BIND;
    ...
    var Cg = "undefined" != typeof window && (window.requestAnimationFrame && window.requestAnimationFrame.bind(window) || window.msRequestAnimationFrame && window.msRequestAnimationFrame.bind(window) || window.mozRequestAnimationFrame || window.webkitRequestAnimationFrame) || function (t) {
            setTimeout(t, 16)
        }, Dg = new Yp(50), Ag = {}, kg = 0, Pg = 5e3, Lg = /\{([a-zA-Z0-9_]+)\|([^}]*)\}/g, Og = "12px sans-serif",
        Bg = {};
    Bg.measureText = function (t, e) {
        var n = l();
        return n.font = e || Og, n.measureText(t)
    };
    var Eg = Og, zg = {left: 1, right: 1, center: 1}, Rg = {top: 1, bottom: 1, middle: 1},
        ...
        Fg = {}, Vg = {}, Hg = new Tn, Gg = function () {
        };
    Gg.prototype = {
        constructor: Gg, drawRectText: function (t, e) {
            var n = this.style;
    ...
    var Wg = 1e5, Xg = 314159, Ug = .01, Yg = .001, qg = new Tn(0, 0, 0, 0), jg = new Tn(0, 0, 0, 0),
        Zg = function (t, e, n) {
            this.type = "canvas";
    ...
    Zg.prototype = {
        constructor: Zg, getType: function () {
            return "canvas"
            ...
            var t = this.getLayer(Xg).ctx, e = this._domRoot.width, n = this._domRoot.height;
    ...
    var $g = 300, Qg = Qf.domSupported, Jg = function () {
    ...
    }(), tv = {mouse: ["mousemove", "mouseup"], pointer: ["pointermove", "pointerup"]}, ev = Vi.prototype;
    ...
    var av = !Qf.canvasSupported, ov = {canvas: Zg}, sv = {}, lv = "4.3.1", uv = function (t, e, n) {
        n = n || {}, this.dom = e, this.id = t;
        var i = this, r = new gg, a = n.renderer;
        if (av) {
        ...
        this.handler = new Lp(r, o, s, o.root), this.animation = new Kg({stage: {update: y(this.flush, this)}}), this.animation.start(), this._needsRefresh;
    ...
    var hv = (Object.freeze || Object)({version: lv, init: ji, dispose: Zi, getInstance: Ki, registerPainter: $i}),
        cv = f, dv = S, fv = x, pv = "series\x00",
        ...
        vv = 0, mv = ".", yv = "___EC__COMPONENT__CONTAINER___", _v = 0, xv = function (t) {
        ...
        }, Iv = Math.pow, Tv = Math.sqrt, Cv = 1e-8, Dv = 1e-4, Av = Tv(3), kv = 1 / 3, Pv = H(), Lv = H(), Ov = H(),
        Bv = Math.min, Ev = Math.max, zv = Math.sin, Rv = Math.cos, Nv = 2 * Math.PI, Fv = H(), Vv = H(), Hv = H(),
        Gv = [], Wv = [], Xv = {M: 1, L: 2, C: 3, Q: 4, A: 5, Z: 6, R: 7}, Uv = [], Yv = [], qv = [], jv = [],
        Zv = Math.min, Kv = Math.max, $v = Math.cos, Qv = Math.sin, Jv = Math.sqrt, tm = Math.abs,
        em = "undefined" != typeof Float32Array, nm = function (t) {
    ...
    nm.prototype = {
        ...
        _dashedLineTo: function (t, e) {
            var n, i, r = this._dashSum, a = this._dashOffset, o = this._lineDash, s = this._ctx, l = this._xi,
                u = this._yi, h = t - l, c = e - u, d = Jv(h * h + c * c), f = l, p = u, g = o.length;
    ...
    var im = 2 * Math.PI, rm = 2 * Math.PI, am = nm.CMD, om = 2 * Math.PI, sm = 1e-4, lm = [-1, -1, -1], um = [-1, -1],
        hm = Ig.prototype.getCanvasPattern, cm = Math.abs, dm = new nm(!0);
    ta.prototype = {
        constructor: ta,
        type: "path",
        __dirtyPath: !0,
        ...
        subPixelOptimize: !1,
        brush: function (t, e) {
            var n = this.style, i = this.path || dm, r = n.hasStroke(), a = n.hasFill(), o = n.fill, s = n.stroke,
    ...
    var fm = nm.CMD, pm = [[], [], []], gm = Math.sqrt, vm = Math.atan2, mm = function (t, e) {
        var n, i, r, a, o, s, l = t.data, u = fm.M, h = fm.C, c = fm.L, d = fm.R, f = fm.A, p = fm.Q;
        for (r = 0, a = 0; r < l.length;) {
            switch (n = l[r++], a = r, i = 0, n) {
                ...
                case p:
                    ...
                    break;
                case f:
                    var g = e[4], v = e[5], m = gm(e[0] * e[0] + e[1] * e[1]), y = gm(e[2] * e[2] + e[3] * e[3]),
                        _ = vm(-e[1] / y, e[0] / m);
    ...
    }, ym = Math.sqrt, _m = Math.sin, xm = Math.cos, wm = Math.PI, bm = function (t) {
        return Math.sqrt(t[0] * t[0] + t[1] * t[1])
    }, Sm = function (t, e) {
        return (t[0] * e[0] + t[1] * e[1]) / (bm(t) * bm(e))
    }, Mm = function (t, e) {
        return (t[0] * e[1] < t[1] * e[0] ? -1 : 1) * Math.acos(Sm(t, e))
    }, Im = /([mlvhzcqtsa])([^mlvhzcqtsa]*)/gi, Tm = /-?([0-9]*\.)?[0-9]+([eE]-?[0-9]+)?/g, Cm = function (t) {
        Ti.call(this, t)
    };
    Cm.prototype = {
        constructor: Cm, type: "text", brush: function (t, e) {
            var n = this.style;
    ...
    Ym.prototype = {
        constructor: Ym, addColorStop: function (t, e) {
    ...
    qm.prototype = {constructor: qm}, h(qm, Ym);
    ...
    jm.prototype = {constructor: jm}, h(jm, Ym), fa.prototype.incremental = !0, fa.prototype.clearDisplaybles = function () {
    ...
    var Km = Math.max, $m = Math.min, Qm = {}, Jm = 1,
        ty = {color: "textFill", textBorderColor: "textStroke", textBorderWidth: "textStrokeWidth"}, ey = "emphasis",
        ny = "normal", iy = 1, ry = {}, ay = {}, oy = oa, sy = ca, ly = N(), uy = 0;
    ...
    var hy = (Object.freeze || Object)({
        ...
        py = {
            getItemStyle: function (t, e) {
                var n = fy(this, t, e), i = this.getBorderLineDash();
    ...
    var my = 0, yy = 1e-4, _y = 9007199254740991,
        ...
        Iy = ["a", "b", "c", "d", "e", "f", "g"], Ty = function (t, e) {
            return "{" + t + (null == e ? "" : e) + "}"
        }, Cy = $n, Dy = (Object.freeze || Object)({
            addCommas: Ro,
            toCamelCase: No,
            ...
            getTextRect: qo,
            windowOpen: jo
        }), Ay = f, ky = ["left", "right", "top", "bottom", "width", "height"],
        Py = [["width", "left", "right"], ["height", "top", "bottom"]], Ly = Zo,
    ...
    xr(Ey, {registerWhenExtend: !0}), mo(Ey), yo(Ey, ts), c(Ey, Oy);
    var zy = "";
    ...
    var Ry = {
        ...
        }, Vy = "original", Hy = "arrayRows", Gy = "objectRows", Wy = "keyedColumns", Xy = "unknown", Uy = "typedArray",
        Yy = "column", qy = "row";
    ns.seriesDataToSource = function (t) {
        return new ns({data: t, sourceFormat: I(t) ? Uy : Vy, fromDataset: !1})
    }, mr(ns);
    var jy = {Must: 1, Might: 2, Not: 3}, Zy = lr(), Ky = "\x00_ec_inner", $y = fo.extend({
    ...
    var a_ = f, o_ = S, s_ = ["areaStyle", "lineStyle", "nodeStyle", "linkStyle", "chordStyle", "label", "labelLine"],
        l_ = function (t, e) {
    ...
    var w_ = lr(), b_ = Ey.extend({
        ...
        getColorFromPalette: function (t, e, n) {
            var i = this.ecModel, r = Fy.getColorFromPalette.call(this, t, e, n);
    ...
    }, vr(S_), xr(S_, {registerWhenExtend: !0});
    var I_ = function () {
        var t = lr();
        return function (e) {
    ...
    var A_ = {
    ...
    }, k_ = "\x00__throttleOriginMethod", P_ = "\x00__throttleRate", L_ = "\x00__throttleType", O_ = {
        ...
        var n = new dg, i = new Fm({style: {fill: e.maskColor}, zlevel: e.zlevel, z: 1e4});
        n.add(i);
        var r = e.fontSize + " sans-serif", a = new Fm({
            style: {
                fill: "none",
                text: e.text,
                font: r,
        ...
        if (n.add(a), e.showSpinner) {
            var o = new Xm({
                shape: {startAngle: -z_ / 2, endAngle: -z_ / 2 + .1, r: e.spinnerRadius},
                style: {stroke: e.color, lineCap: "round", lineWidth: e.lineWidth},
                zlevel: e.zlevel,
                z: 10001
            });
            o.animateShape(!0).when(1e3, {endAngle: 3 * z_ / 2}).start("circularInOut"), o.animateShape(!0).when(1e3, {startAngle: 3 * z_ / 2}).delay(300).start("circularInOut"), n.add(o)
        }
    ...
    var X_ = ["#37A2DA", "#32C5E9", "#67E0E3", "#9FE6B8", "#FFDB5C", "#ff9f7f", "#fb7293", "#E062AE", "#E690D1", "#e7bcf3", "#9d96f5", "#8378EA", "#96BFFF"],
        U_ = {
            ...
            return {
                axisLine: {lineStyle: {color: Y_}},
                axisTick: {lineStyle: {color: Y_}},
                axisLabel: {textStyle: {color: Y_}},
                splitLine: {lineStyle: {type: "dashed", color: "#aaa"}},
                splitArea: {areaStyle: {color: Y_}}
            }
        },
        ...
        Z_ = {
            color: j_,
            backgroundColor: "#333",
            tooltip: {axisPointer: {lineStyle: {color: Y_}, crossStyle: {color: Y_}, label: {color: "#000"}}},
            legend: {textStyle: {color: Y_}},
            textStyle: {color: Y_},
            title: {textStyle: {color: Y_}},
            toolbox: {iconStyle: {normal: {borderColor: Y_}}},
            dataZoom: {textStyle: {color: Y_}},
            visualMap: {textStyle: {color: Y_}},
            timeline: {
                lineStyle: {color: Y_},
                itemStyle: {normal: {color: j_[1]}},
                label: {normal: {textStyle: {color: Y_}}},
                controlStyle: {normal: {color: Y_, borderColor: Y_}}
            },
            timeAxis: q_(),
            logAxis: q_(),
            valueAxis: q_(),
            ...
            line: {symbol: "circle"},
            graph: {color: j_},
            gauge: {title: {textStyle: {color: Y_}}},
            candlestick: {
                itemStyle: {
                    normal: {
                        color: "#FD1050",
    ...
    Z_.categoryAxis.splitLine.show = !1, Ey.extend({
        type: "dataset",
        defaultOption: {seriesLayoutBy: Yy, sourceHeader: null, dimensions: null, source: null},
        optionUpdated: function () {
            is(this)
        }
    ...
    var Q_ = {
        ...
        }, ex = /url\(\s*#(.*?)\)/, nx = /(translate|scale|rotate|skewX|skewY|matrix)\(([\-\s0-9\.e,]*)\)/g,
        ix = /([^\s:;]+)\s*:\s*([^:;]+)/g, rx = N(), ax = {
        ...
        }, sx = O, lx = f, ux = w, hx = S, cx = Ey.parseClassType, dx = "4.8.0", fx = {zrender: "4.3.1"}, px = 1, gx = 1e3,
        vx = 800, mx = 900, yx = 5e3, _x = 1e3, xx = 1100, bx = 2e3, Sx = 3e3, Mx = 3500, Ix = 4e3, Tx = 5e3, Cx = {
            PROCESSOR: {FILTER: gx, SERIES_FILTER: vx, STATISTIC: yx},
            VISUAL: {
                LAYOUT: _x,
        ...
        }, Dx = "__flagInMainProcess", Ax = "__optionUpdated", kx = /^[a-zA-Z0-9_]+$/;
    ...
    Px._onframe = function () {
        if (!this._disposed) {
            ...
            if (this[Ax]) {
                ...
                var n = px, i = this._model, r = this._api;
                t.unfinished = !1;
                do {
                    var a = +new Date;
        ...
        if (!this._disposed) {
            ...
            if (hx(e) && (n = e.lazyUpdate, i = e.silent, e = e.notMerge), this[Dx] = !0, !this._model || e) {
                var r = new Is(this._api), a = this._theme, o = this._model = new $y;
                o.scheduler = this._scheduler, o.init(null, null, a, r)
            }
            this._model.setOption(t, Rx), n ? (this[Ax] = {silent: i}, this[Dx] = !1) : (Yl(this), Lx.update.call(this), this._zr.flush(), this[Ax] = !1, this[Dx] = !1, Kl.call(this, i), $l.call(this, i))
        }
        ...
        if (!this._disposed && Qf.canvasSupported) {
            ...
            if (Wx[n]) {
                ...
                var p = u - s, g = h - l, v = up(), m = ji(v, {renderer: e ? "svg" : "canvas"});
                ...
                return t.connectedBackgroundColor && m.add(new Fm({
                    ...
                    var e = new Ci({style: {x: t.left * d - s, y: t.top * d - l, image: t.dom}});
                    m.add(e)
    ...
    var Lx = {
        prepareAndUpdate: function (t) {
            ...
            if (e) {
                ...
                if (Qf.canvasSupported) i.setBackgroundColor(o); else {
                    var s = Je(o);
    ...
    Px.resize = function (t) {
        ...
        if (!this._disposed && (hx(t) && (e = t, t = ""), t = t || "default", this.hideLoading(), Hx[t])) {
            var n = Hx[t](this._api, e), i = this._zr;
        ...
        if (!this._disposed && (hx(e) || (e = {silent: !!e}), Bx[t.type] && this._model)) {
    ...
    var Bx = {}, Ex = {}, zx = [], Rx = [], Nx = [], Fx = [], Vx = {}, Hx = {}, Gx = {}, Wx = {}, Xx = new Date - 0,
        Ux = new Date - 0, Yx = "_echarts_instance_", qx = fu;
    Iu(bx, O_), yu(c_), _u(mx, d_), Cu("default", R_), wu({
        type: "highlight",
        event: "highlight",
        update: "highlight"
    }, V), wu({type: "downplay", event: "downplay", update: "downplay"}, V), mu("light", U_), mu("dark", Z_);
    var jx = {};
    zu.prototype = {
        constructor: zu, add: function (t) {
    ...
    var Zx = N(["tooltip", "label", "itemName", "itemId", "seriesName"]), Kx = S, $x = "undefined", Qx = -1,
        Jx = "e\x00\x00", tw = {
            ...
            number: Array,
            time: Array
        }, ew = typeof Uint32Array === $x ? Array : Uint32Array, nw = typeof Int32Array === $x ? Array : Int32Array,
        ...
        aw = ["_extent", "_approximateExtent", "_rawExtent"], ow = function (t, e) {
            t = t || ["x", "y"];
    ...
    sw.type = "list", sw.hasItemOption = !0, sw.getDimension = function (t) {
        ...
        if (Kx(t)) for (var n in t) t.hasOwnProperty(n) && this.setVisual(n, t[n]); else this._visual = this._visual || {}, this._visual[t] = e
    }, sw.setLayout = function (t, e) {
        if (Kx(t)) for (var n in t) t.hasOwnProperty(n) && this.setLayout(n, t[n]); else this._layout[t] = e
        ...
        if (this._itemVisuals[t] = i, Kx(e)) for (var a in e) e.hasOwnProperty(a) && (i[a] = e[a], r[a] = !0); else i[e] = n, r[e] = !0
    ...
    var dw = ph.prototype, fw = ph.extend({
    ...
    var mw = "__ec_stack_", yw = .5, _w = "undefined" != typeof Float32Array ? Float32Array : Array, xw = {
            seriesType: "bar", plan: I_(), reset: function (t) {
                ...
                if (kh(t) && Ph(t)) {
                    var n = t.getData(), i = t.coordinateSystem, r = i.grid.getRect(), a = i.getBaseAxis(),
                        ...
                        h = u ? 0 : 1, c = Dh(Th([t]), a, t).width;
                    return c > yw || (c = yw), {progress: e}
                }
            }
        }, ww = vw.prototype, bw = Math.ceil, Sw = Math.floor, Mw = 1e3, Iw = 60 * Mw, Tw = 60 * Iw, Cw = 24 * Tw,
        Dw = function (t, e, n, i) {
            for (; i > n;) {
                var r = n + i >>> 1;
                t[r][1] < e ? n = r + 1 : i = r
            ...
            type: "time", getLabel: function (t) {
                ...
                var o = kw.length, s = Dw(kw, a, 0, o), l = kw[Math.min(s, o - 1)], u = l[1];
                if ("year" === l[0]) {
    ...
    Aw.create = function (t) {
        return new Aw({useUTC: t.ecModel.get("useUTC")})
    };
    var Pw = ph.prototype, Lw = vw.prototype, Ow = Io, Bw = bo, Ew = Math.floor, zw = Math.ceil, Rw = Math.pow,
        Nw = Math.log, Fw = ph.extend({
            ...
            }, getMinorTicks: Lw.getMinorTicks, getLabel: Lw.getLabel, scale: function (t) {
                return t = Pw.scale.call(this, t), Rw(this.base, t)
            }, setExtent: function (t, e) {
                var n = this.base;
                t = Nw(t) / Nw(n), e = Nw(e) / Nw(n), Lw.setExtent.call(this, t, e)
            }, getExtent: function () {
                var t = this.base, e = Pw.getExtent.call(this);
    ...
    var Vw = {
        ...
        }), Uw = {line: Hm, rect: Fm, roundRect: Fm, square: Fm, circle: Dm, diamond: Gw, pin: Ww, arrow: Xw, triangle: Hw},
        Yw = {
    ...
    }), Zw = {isDimensionStacked: uh, enableDataStack: lh, getStackedDimension: hh}, Kw = (Object.freeze || Object)({
        createList: qh,
        getLayoutRect: Ko,
        dataStack: Zw,
        createScale: jh,
    ...
    ab.prototype = {
        constructor: ab, type: "cartesian", getAxis: function (t) {
            return this._axes[t]
        }, getAxes: function () {
    ...
    ob.prototype = {
        constructor: ob, index: 0, getAxesOnZeroOf: null, model: null, isHorizontal: function () {
            var t = this.position;
    ...
    }, sb), lb.timeAxis = s({scale: !0, min: "dataMin", max: "dataMax"}, lb.valueAxis), lb.logAxis = s({
        scale: !0,
        logBase: 10
    }, lb.valueAxis);
    var ub = ["value", "category", "time", "log"], hb = function (t, e, n, i) {
        f(ub, function (o) {
            e.extend({
        ...
        function n(n) {
            return function (o, s) {
                if (xc(o, t, e)) {
                    ...
                    var u = new ob(n, Rh(o), [0, 0], o.get("type"), l), h = "category" === u.type;
    ...
    o(fo.prototype, mb), Pu({
        type: "bar", render: function (t, e, n) {
            ...
            var h = t.get("roundCap", !0), c = t.get("showBackground", !0), d = t.getModel("backgroundStyle"),
                f = d.get("barBorderRadius") || 0, p = [], g = this._backgroundEls || [];
            i.diff(r).add(function (r) {
                var o = i.getItemModel(r), g = Ib[a.type](i, r, o);
                if (c) {
                    var v = Ib[a.type](i, r), m = Xc(a, e, v);
                ...
                var m = i.getItemModel(o), y = Ib[a.type](i, o, m);
                if (c) {
                    var _ = g[v];
                    _.useStyle(d.getBarItemStyle()), "cartesian2d" === a.type && _.setShape("r", f), p[o] = _;
                    var x = Ib[a.type](i, o), w = Wc(e, x, a);
                    Ja(_, {shape: w}, s, o)
                }
                ...
                b ? Ja(b, {shape: y}, s, o) : b = Mb[a.type](o, y, e, s, !0, h), i.setItemGraphicEl(o, b), n.add(b), Rc(b, i, o, m, y, t, e, "polar" === a.type)
            }).remove(function (t) {
    ...
    var wb = Math.max, bb = Math.min, Sb = {
        ...
        cartesian2d: function (t, e, n, i, r) {
            var a = new Fm({shape: o({}, e), z2: 1});
            if (a.name = "item", i) {
                var s = a.shape, l = n ? "height" : "width", u = {};
                s[l] = 0, u[l] = e[l], hy[r ? "updateProps" : "initProps"](a, {shape: u}, i, t)
            }
            return a
        }, polar: function (t, e, n, i, r, a) {
            var o = e.startAngle < e.endAngle, l = !n && a ? yb : Pm, u = new l({shape: s({clockwise: o}, e), z2: 1});
            if (u.name = "item", i) {
                var h = u.shape, c = n ? "r" : "endAngle", d = {};
                h[c] = n ? 0 : e.startAngle, d[c] = e[c], hy[r ? "updateProps" : "initProps"](u, {shape: d}, i, t)
            }
            return u
        }
    }, Ib = {
        ...
        axisLine: function () {
            ...
            if (n) {
                ...
                var p = s.getFont(), g = e.get("nameTruncate", !0) || {}, v = g.ellipsis,
                    ...
                    y = null != v && null != m ? Cy(n, m, p, v, {minChar: 2, placeholder: g.placeholder}) : n,
    ...
    var Nb = ["axisLine", "axisTickLabel", "axisName"], Fb = ["splitArea", "splitLine", "minorSplitLine"],
        Vb = zb.extend({
            type: "cartesianAxis", axisPointerClass: "CartesianAxisPointer", render: function (t, e, n, i) {
                ...
                if (this._axisGroup = new dg, this.group.add(this._axisGroup), t.get("show")) {
                    var a = t.getCoordSysModel(), o = fd(a, t), s = new Ab(t, o);
    ...
    Vb.extend({type: "xAxis"}), Vb.extend({type: "yAxis"}), Au({
    ...
    var Hb = vd.prototype, Gb = vd.getSymbolSize = function (t, e) {
    ...
    Hb._createSymbol = function (t, e, n, i, r) {
        ...
        this.silent = !1;
        var i = t.getItemVisual(e, "symbol") || "circle", r = t.hostModel, a = Gb(t, e), o = i !== this._symbolType;
        if (o) {
    ...
    var Wb = ["itemStyle"], Xb = ["emphasis", "itemStyle"], Ub = ["label"], Yb = ["emphasis", "label"];
    ...
    }, Zb = oe, Kb = se, $b = Y, Qb = G, Jb = [], tS = [], eS = [], nS = ta.extend({
        type: "ec-polyline",
    ...
    hl.extend({
        type: "line", init: function () {
            ...
            var i = t.coordinateSystem, r = this.group, a = t.getData(), o = t.getModel("lineStyle"),
                ...
                v = t.get("animation"), m = !l.isEmpty(), y = l.get("origin"), _ = Md(i, a, y), x = zd(i, a, _),
            ...
            var o = this._polyline, s = this._polygon, l = t.hostModel,
                u = jb(this._data, t, this._stackedOnPoints, e, this._coordSys, n, this._valueOrigin, a), h = u.current,
    ...
    var uS = function (t, e, n) {
        ...
        var i = t.getSource(), r = uw(i, e), a = new ow(r, t);
        ...
        getInitialData: function () {
            return uS(this, {coordDimensions: ["value"], encodeDefaulter: _(ds, this)})
        },
    ...
    var fS = (hl.extend({
        type: "pie", init: function () {
            ...
            var l = new Pm({shape: {cx: t, cy: e, r0: 0, r: n, startAngle: i, endAngle: i, clockwise: r}}),
                u = s ? to : Ja;
    ...
    }, gS = Math.PI / 180, vS = function (t, e, n, i, r, a) {
        var o, s, l = t.getData(), u = [], h = !1, c = (t.get("minShowLabelAngle") || 0) * gS;
        l.each(function (i) {
            ...
            if (b = wo(b, n), !(a.angle < c)) {
                ...
                o = a.cx, s = a.cy;
                var k = t.getFormattedLabel(i, "normal") || l.getName(i), P = Un(k, _, T, "top"),
                    L = "inside" === p || "inner" === p;
    ...
    }, mS = 2 * Math.PI, yS = Math.PI / 180, _S = function (t, e, n) {
        e.eachSeriesByType(t, function (t) {
            ...
            var s = wo(r.width, n.getWidth()), l = wo(r.height, n.getHeight()), u = Math.min(s, l),
                ...
                p = -t.get("startAngle") * yS, g = t.get("minAngle") * yS, v = 0;
            e.each(i, function (t) {
                !isNaN(t) && v++
            });
        ...
        type: "title", render: function (t, e, n) {
            if (this.group.removeAll(), t.get("show")) {
                var i = this.group, r = t.getModel("textStyle"), a = t.getModel("subtextStyle"), o = t.get("textAlign"),
                    s = A(t.get("textBaseline"), t.get("textVerticalAlign")), l = new Cm({
                        style: Wa({}, r, {text: t.get("text"), textFill: r.getTextColor()}, {disableBox: !0}),
                        z2: 10
                    }), u = l.getBoundingRect(), h = t.get("subtext"), c = new Cm({
                        style: Wa({}, a, {
                            text: h,
    ...
    var wS = B_.legend.selector,
        bS = {all: {type: "all", title: i(wS.all)}, inverse: {type: "inverse", title: i(wS.inverse)}}, SS = Du({
            type: "legend.plain",
            dependencies: ["series"],
            layoutMode: {type: "box", ignoreSize: !0},
            init: function (t, e, n) {
            ...
            _updateSelector: function (t) {
                ...
                e === !0 && (e = t.selector = ["all", "inverse"]), x(e) && f(e, function (t, n) {
                    b(t) && (t = {type: t}), e[n] = r(t, bS[t.type])
                })
            },
            optionUpdated: function () {
    ...
    var AS = SS.extend({
    ...
    }), kS = dg, PS = ["width", "height"], LS = ["x", "y"], OS = CS.extend({
        type: "legend.scroll", newlineDisabled: !0, init: function () {
            ...
            var s = this.getSelectorGroup(), l = t.getOrient().index, u = PS[l], h = LS[l], c = PS[1 - l],
                d = LS[1 - l];
            ...
            if (y[r] = d ? n[r] : h[r], y[a] = Math.max(h[a], c[a]), y[o] = Math.min(0, c[o] + g[1 - i]), l.__rectSize = n[r], d) {
                var _ = {x: 0, y: 0};
                _[r] = Math.max(n[r] - c[r] - v, 0), _[a] = y[a], l.setClipPath(new Fm({shape: _})), l.__rectSize = _[r]
            ...
            var i = t.get("scrollDataIndex", !0), r = this.getContentGroup(), a = this._containerGroup.__rectSize,
                o = t.getOrient().index, s = PS[o], l = LS[o], u = this._findTargetItemIndex(i), h = r.children(),
    ...
    var BS = function (t, e) {
        ...
        return {point: i, el: s}
    }, ES = f, zS = _, RS = lr(), NS = function (t, e, n) {
        var i = t.currTrigger, r = [t.x, t.y], a = t, o = t.dispatchAction || y(n.dispatchAction, n),
            s = e.getComponent("axisPointer").coordSysAxesInfo;
        if (s) {
            ff(r) && (r = BS({seriesIndex: a.seriesIndex, dataIndex: a.dataIndex}, e).point);
            var l = ff(r), u = a.axesInfo, h = s.axesInfo, c = "leave" === i || ff(r), d = {}, f = {},
                p = {list: [], map: {}}, g = {showPointer: zS(of, f), showTooltip: zS(sf, p)};
    ...
    var US = wf.extend({
        makeElOption: function (t, e, n, i, r) {
            var a = n.axis, o = a.grid, s = i.get("type"), l = Ef(o, a).getOtherAxis(a).getGlobalExtent(),
                u = a.toGlobalCoord(a.dataToCoord(e, !0));
            if (s && "none" !== s) {
                var h = Cf(i), c = YS[s](a, u, l);
            ...
            var i = n.axis, r = i.grid, a = i.getGlobalExtent(!0), o = Ef(r, i).getOtherAxis(i).getGlobalExtent(),
        ...
        line: function (t, e, n) {
            ...
            return {type: "Rect", shape: Bf([e - i / 2, n[0]], [i, r], zf(t))}
        }
    };
    ...
    Hf.prototype = {
        ...
        constructor: Gf, _enterable: !0, update: function () {
        }, show: function () {
    ...
    var $S = y, QS = f, JS = wo, tM = new Fm({shape: {x: -1, y: -1, width: 2, height: 2}});
    Au({
        type: "tooltip", init: function (t, e) {
            if (!Qf.node) {
                ...
                var r;
                "html" === this._renderMode ? (r = new Hf(e.getDom(), e, {appendToBody: n.get("appendToBody", !0)}), this._newLine = "<br/>") : (r = new Gf(e), this._newLine = "\n"), this._tooltipContent = r
            }
        }, render: function (t, e, n) {
            if (!Qf.node) {
            ...
            if (null != r && null != a && null != o) {
                ...
                if (s) {
                    var l = s.getData(), t = Wf([l.getItemModel(a), s, (s.coordinateSystem || {}).model, t]);
            ...
            var n = this._ecModel, i = this._tooltipModel, a = [e.offsetX, e.offsetY], o = [], s = [],
                l = Wf([e.tooltipOption, i]), u = this._renderMode, h = this._newLine, c = {};
            QS(t, function (t) {
            ...
            if (o && d.applyTransform(o.transform), "function" == typeof e && (e = e([n, i], a, r.el, d, {
                viewSize: [s, l],
                contentSize: u.slice()
            })), x(e)) n = JS(e[0], s), i = JS(e[1], l); else if (S(e)) {
